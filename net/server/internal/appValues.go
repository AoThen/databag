...
// APPLoginFailPeriod time window login failures can occur
...
// APPPasswordMinLength minimum password length
const APPPasswordMinLength = 8

// APPPasswordMaxLength maximum password length
