  ...
  const loadAccounts = async () => {
    if (!loading) {
      ...
      try {
        ...
        handleAppErrorWithAlert(err, 'loadAccounts');
      }
      setLoading(false);
    }
  };
  ...
  const accessAccount = async (accountId: number) => {
    ...
    if (!accessing) {
      ...
      try {
        ...
        handleAppErrorWithAlert(err, 'accessAccount');
        setFailed(true);
      }
      setAccessing(null);
    }
  ...
  const addAccount = async () => {
    if (!adding) {
      ...
      try {
        ...
        handleAppErrorWithAlert(err, 'addAccount');
        setFailed(true);
      }
      setAdding(false);
    }
  ...
  const blockAccount = async (accountId: number, block: boolean) => {
    ...
    if (!blocking) {
      ...
      try {
        ...
        handleAppErrorWithAlert(err, 'blockAccount');
        setFailed(true);
      }
      setBlocking(null);
    }
