...
export function Contacts({
  ...
  const call = useCallback(async (card: Card) => {
    ...
    try {
      ...
      handleAppErrorWithAlert(err, 'call');
      setAlert(true);
    }
    setMenuAction(null);
  }, [actions, callContact]);
  ...
  const text = useCallback(async (card: Card) => {
    ...
    try {
      ...
      handleAppErrorWithAlert(err, 'text');
      setAlert(true);
    }
    setMenuAction(null);
  }, [textContact]);
  ...
  const resync = useCallback(async (card: Card) => {
    ...
    try {
      ...
      handleAppErrorWithAlert(err, 'resync');
      setAlert(true);
    }
    setMenuAction(null);
  }, [actions]);
  ...
  const cancel = useCallback(async (card: Card) => {
    ...
    try {
      ...
      handleAppErrorWithAlert(err, 'cancel');
      setAlert(true);
    }
    setMenuAction(null);
  }, [actions]);
  ...
  const connect = useCallback(async (card: Card) => {
    ...
    try {
      ...
      handleAppErrorWithAlert(err, 'connect');
      setAlert(true);
    }
    setMenuAction(null);
  }, [actions]);
  ...
  const disconnect = useCallback(async (card: Card) => {
    ...
    try {
      ...
      handleAppErrorWithAlert(err, 'disconnect');
      setAlert(true);
    }
    setMenuAction(null);
  }, [actions]);
  ...
  const accept = useCallback(async (card: Card) => {
    ...
    try {
      ...
      handleAppErrorWithAlert(err, 'accept');
      setAlert(true);
    }
    setMenuAction(null);
  }, [actions]);
