...
export const zh = {
  ...
  addAccount: '添加账户',
  generate: '生成',
  keyboardOffset: '额外键盘偏移',
  layout: '布局',

  appPermission: '应用无权访问媒体',

  sureLogout: '确定要退出登录吗？',
  changePrompt: '您可以在此处更改账户的用户名和/或密码',
  ...
  welcomeTo: '欢迎使用Databag',
  notUser: '还没有账户？',
  adminAccess: '管理员访问',
  yourProfile: '设置您的个人资料',
  connectWith: '与人联系',
  startTopic: '开始对话',
  getStarted: '开始',
  enterName: '输入您的姓名',
  ...
  skipSetup: '跳过',
  allDone: '完成！',
  moreContacts: '更多联系人可在联系人标签中找到。接受后，您可以开始私密对话。',
  messaging: '消息',
  manageSealed: '管理加密主题',
  format: '格式',
  fontFormat: 'Aa 字体大小',
  ...
  support: '支持',
  requestSent: '请求已发送',
  friendsNotified: '您的朋友将收到您添加他们的通知！',
  appLanguage: '应用语言',
  languageName: '中文',
  ...
  created: '已创建',
  flagMessage: '标记消息',
  flagMessagePrompt: '确定要将消息标记给管理员吗？',
  flag: '标记',
  blockMessage: '屏蔽消息',
  blockMessagePrompt: '确定要屏蔽这条消息吗？',
  ...
  connectingStatus: '请求已发送',
  requestedStatus: '联系人请求的连接',
  ...
  sealDelete: '删除加密密钥将永久撤销所有设备对端到端加密消息的访问权限',
  ...
  errorServerUnavailable: '服务器不可用，请稍后重试。',
  errorUnauthorized: '用户名或密码错误。',
  errorForbidden: '访问被拒绝，请检查凭据。',
  errorNotFound: '该服务器上未找到此账户。',
  errorConflict: '用户名已被占用。',
  errorTooManyRequests: '请求过于频繁，请稍后重试。',
  errorTimeout: '连接超时，请重试。',
  errorUnknown: '发生未知错误。',

  sealRequired: '未设置E2EE密钥且管理员要求设置',
  ...
  requestedTip: '联系人请求的连接',
  connectingTip: '请求连接中',
  pendingTip: '未知联系人请求的连接',
  confirmedTip: '断开的联系人',
  unsavedTip: '未知联系人',
  ...
  enableWeb: '启用WebRTC通话',
  webHint: '允许与联系人进行音频和视频通话',
  enableService: 'Cloudflare服务',
  serviceHint: '启用Cloudflare服务',
  serverUrl: 'WebRTC服务器URL',
  urlHint: 'turn:ip:port?transport=udp',
  webUsername: 'WebRTC用户名',
  webPassword: 'WebRTC密码',
  failedLoad: '加载失败',
  limit: '限制',

  deleteMessage: '删除消息',
  messageHint: '确定要删除消息吗？',
  fontColor: '更改字体颜色',
  fontSize: '更改字体大小',
  postMessage: '发布消息',
  ...
  blockTopic: '屏蔽主题',
  blockTopicPrompt: '确定要屏蔽此主题吗？',
  reportTopic: '举报主题',
  reportTopicPrompt: '确定要将此主题标记给管理员审核吗？',

  ignoring: '忽略联系人',
  connfirmIgnoring: '确定要忽略此请求吗？',
  denying: '拒绝联系人',
  confirmDenying: '确定要拒绝此请求吗？',
  reporting: '举报联系人',
  confirmReporting: '确定要举报此联系人吗？',
  blocking: '屏蔽联系人',
  confirmBlocking: '确定要屏蔽此联系人吗？',
  disconnecting: '与联系人断开连接',
  confirmDisconnecting: '确定要与此联系人断开连接吗？',

  removing: '删除联系人',
  confirmRemove: '确定要删除此联系人吗？',
  message: '消息',
  securedMessage: '加密消息',
