    ...
    <div className={classes.conversation}>
      <div className={classes.header}>
        ...
        <div className={classes.title}>
          ...
          {state.detailSet && !state.subject && state.subjectNames.length > 0 && <Text className={classes.label}>{state.subjectNames.join(', ')}</Text>}
          {state.detailSet && !state.subject && state.unknownContacts > 0 && <Text className={classes.unknown}>{`, ${state.strings.unknownContact} (${state.unknownContacts})`}</Text>}
        </div>
