...
export const en = {
  ...
  ipBlockManagement: 'IP Block Management',
  blockIP: 'Block IP',
  ...
  action: 'Action',
  unblock: 'Unblock',
  failedToBlockIP: 'Failed to block IP',
...
export const fr = {
  ...
  ipBlockManagement: 'Gestion des Bloquages IP',
  blockIP: 'Bloquer IP',
  ...
  whitelistedIPs: 'IPs en Liste Blanche',
  expires: 'Expire',
  added: 'Ajouté',
  action: 'Action',
  unblock: 'Débloquer',
  failedToBlockIP: 'Échec du blocage IP',
...
export const es = {
  ...
  ipBlockManagement: 'Gestión de Bloqueos IP',
  blockIP: 'Bloquear IP',
  ...
  whitelistedIPs: 'IPs en Lista Blanca',
  expires: 'Expira',
  action: 'Acción',
  unblock: 'Desbloquear',
  failedToBlockIP: 'Error al bloquear IP',
...
export const pt = {
  ...
  ipBlockManagement: 'Gerenciamento de Bloqueio IP',
  blockIP: 'Bloquear IP',
  ...
  whitelistedIPs: 'IPs na Lista Branca',
  expires: 'Expira',
  added: 'Adicionado',
  action: 'Ação',
  unblock: 'Desbloquear',
  failedToBlockIP: 'Falha ao bloquear IP',
...
export const de = {
  ...
  ipBlockManagement: 'IP-Sperrverwaltung',
  blockIP: 'IP sperren',
  ...
  whitelistedIPs: 'IPs in Whitelist',
  expires: 'Läuft ab',
  added: 'Hinzugefügt',
  action: 'Aktion',
  unblock: 'Entsperren',
  failedToBlockIP: 'IP-Sperre fehlgeschlagen',
...
export const ru = {
  ...
  ipBlockManagement: 'Управление блокировкой IP',
  ...
  whitelistedIPs: 'IP в белом списке',
  expires: 'Истекает',
  added: 'Добавлено',
  action: 'Действие',
  unblock: 'Разблокировать',
  failedToBlockIP: 'Не удалось заблокировать IP',
...
export const el = {
  ...
  ipBlockManagement: 'Διαχείριση Αποκλεισμού IP',
  ...
  addToWhitelist: 'Προσθήκη στη λευκή λίστα',
  note: 'Σημείωση (προαιρετικό)',
  blockedIPs: 'Αποκλεισμένες IP',
  whitelistedIPs: 'IP στη Λευκή Λίστα',
  expires: 'Λήγει',
  action: 'Ενέργεια',
  unblock: 'Αποδέσμευση',
  failedToBlockIP: 'Αποτυχία αποκλεισμού IP',
...
export const zh = {
  yourHostname: '您的管理员尚未配置服务主机名',
  theirHostname: '联系人的管理员尚未配置服务主机名',
  adminSettings: '管理员设置',
  ...
  appPermission: '应用程序没有媒体访问权限',

  sureLogout: '您确定要退出登录吗？',
  changePrompt: '您可以在这里更改账户的用户名和密码',
  typeDelete: '输入 [删除]',
  encryptionKey: '加密密钥',
  generateKey: '生成密钥以启用端到端加密主题',
  moreOptions: '更多选项',
  ...
  addSubject: '添加主题',
  chat: '聊天',
  sealingKey: '管理 E2EE 密钥',
  createSealed: '创建 E2EE 主题',
  noKey: '无密钥',
  ...
  skipSetup: '跳过',
  allDone: '全部完成！',
  moreContacts: '更多联系人可以在联系人选项卡中找到。一旦接受，您可以开始私密对话。',
  messaging: '消息',
  manageSealed: '管理加密主题',
  format: '格式',
  fontFormat: 'Aa 字体大小',
  ...
  support: '支持',
  requestSent: '请求已发送',
  friendsNotified: '您的朋友将被通知您已添加他们！',
  appLanguage: '应用程序语言',
  languageName: '中文',
  ...
  contactsUpdated: '已更新联系人状态',
  disconnected: '与服务器断开连接',
  allDevices: '从所有设备退出登录',
  ok: '确定',
  cancel: '取消',
  ...
  noTopics: '无主题',
  noMessages: '无消息',
  noConnected: '无已连接的联系人',
  subjectOptional: '主题（可选）',
  members: '成员',
  sealedTopic: '加密主题',
  start: '开始',

  communication: '去中心化网络的通信',
  setupProfile: '设置您的资料',
  connectPeople: '与人连接',
  ...
  callTip: '呼叫联系人',
  messageTip: '发送消息给联系人',
  connectedTip: '已连接的联系人',
  requestedTip: '联系人发来的连接请求',
  connectingTip: '连接请求已发送',
  pendingTip: '来自未知联系人的连接请求',
  confirmedTip: '已断开的联系人',
  unsavedTip: '未知联系人',

  unknownStatus: '未保存的联系人',
  savedStatus: '已保存的联系人',
  pendingStatus: '未知的联系人请求',
  connectingStatus: '连接请求已发送',
  requestedStatus: '联系人发来的连接请求',
  connectedStatus: '已连接的联系人',
  offsyncStatus: '不同步的联系人',

  actions: '操作',
  resync: '重新同步',
  connect: '连接',
  disconnect: '断开连接',
  disconnectContact: '断开与联系人的连接',
  deleteContact: '删除联系人',
  saveContact: '保存联系人',
  saveAccept: '保存并接受连接',
  saveRequest: '保存并请求连接',
  ...
  createAccount: '创建账户',
  accountLogin: '账户登录',
  toCreate: '账户通过管理员仪表板生成的链接创建。',
  admin: '管理员',
  loginError: '登录错误',
  loginMessage: '请确认您的用户名和密码。',
  createError: '创建账户错误',
  createMessage: '请与您的管理员联系。',
  adminError: '管理员访问错误',
  adminMessage: '请确认您的密码。',
  ...
  addingToken: '使用以下令牌从登录屏幕创建账户',
  accessingTitle: '正在访问账户',
  accessingLink: '使用以下链接访问指定账户',
  accessingToken: '使用以下令牌从登录屏幕访问指定账户',
  ...
  storageHint: '0 表示无限制',
  keyType: '账户密钥类型',
  accountCreation: '公共账户创建',
  enablePush: '启用推送通知',
  allowUnsealed: '允许未加密主题',
  topicContent: '主题内容：',
  enableImage: '启用图片队列',
  imageHint: '允许在主题中发布图片',
  enableAudio: '启用音频队列',
  audioHint: '允许在主题中发布音频',
  enableVideo: '启用视频队列',
  videoHint: '允许在主题中发布视频',
  enableBinary: '启用二进制文件',
  binaryHint: '允许在主题中发布二进制文件',
  enableWeb: '启用 WebRTC 通话',
  webHint: '允许与联系人进行音频和视频通话',
  enableService: 'Cloudflare 服务',
  serviceHint: '启用 Cloudflare 服务',
  ...
  leave: '离开',
  confirmTopic: '正在删除主题',
  sureTopic: '您确定要删除此主题吗？',
  confirmLeave: '正在离开主题',
  sureLeave: '您确定要离开此主题吗？',
  ...
  flagMessage: '标记消息',
  flagMessagePrompt: '您确定要将此消息标记给管理员吗？',
  flag: '标记',
  blockMessage: '屏蔽消息',
  blockMessagePrompt: '您确定要屏蔽此消息吗？',

  blockTopic: '正在屏蔽主题',
  blockTopicPrompt: '您确定要屏蔽此主题吗？',
  reportTopic: '标记主题',
  reportTopicPrompt: '您确定要将此主题标记给管理员审核吗？',

  ignoring: '正在忽略联系人',
  connfirmIgnoring: '您确定要忽略此请求吗？',
  denying: '正在拒绝联系人',
  confirmDenying: '您确定要拒绝此请求吗？',
  reporting: '正在举报联系人',
  confirmReporting: '您确定要举报此联系人吗？',
  blocking: '正在屏蔽联系人',
  confirmBlocking: '您确定要屏蔽此联系人吗？',
  disconnecting: '正在与联系人断开连接',
  confirmDisconnecting: '您确定要与此联系人断开连接吗？',

  removing: '正在删除联系人',
  confirmRemove: '您确定要删除此联系人吗？',
  message: '消息',
  securedMessage: '加密消息',
  ...
  enableMultifactor: '启用多因素身份验证',
  disableMultifactor: '禁用多因素身份验证',

  disable: '禁用',
  confirmDisable: '正在禁用多因素身份验证',
  disablePrompt: '您确定要禁用多因素身份验证吗？',

  ipBlockManagement: 'IP 封禁管理',
  blockIP: '封禁 IP',
  ipAddress: 'IP 地址',
  reason: '原因',
  duration: '时长（小时）',
