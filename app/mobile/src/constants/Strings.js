...
const Strings = [
  ...
  },
  {
    ...
    // seal wizard
    sealUnset: '生成密钥以启用端到端加密主题。',
    sealUnlocked: '禁用安全密钥将阻止此设备访问所有端到端加密主题，直到密钥再次解锁。',
    sealLocked: '解锁安全密钥以支持此设备上的端到端加密主题。',
    sealDelete: '删除安全密钥将永久移除您所有设备对现有端到端加密主题的访问权限。',
    password: '密码',
    ...
    enableTopics: '启用加密主题',
    manageTopics: '管理安全密钥',
    changePassword: '更改安全密钥密码。',
    update: '更改',
    changeKey: '更改密钥密码',
    delayMessage: '密钥生成可能需要几分钟。',
    changeMessage: '在此处，您可以更改账户的用户名和/或密码。',
    ...
    close: '关闭',
    ok: '确定',
    noBlockedContacts: '无已屏蔽的联系人',
    noBlockedTopics: '无已屏蔽的主题',
    noBlockedMessages: '无已屏蔽的消息',
    restore: '恢复',
    ...
    enableCalls: '启用WebRTC通话',
    iceService: 'Cloudflare服务',
    relayUrl: '中继URL',
    relayUsername: '中继用户名',
    relayPassword: '中继密码',
    ...
    server: '服务器',
    access: '访问',
    defaultPublic: '默认的公共服务器仅用于系统测试。其他情况请使用私有服务器。',
    confirmPassword: '确认密码',
    accountLogin: '账户登录',
    accessAccount: '访问账户',
    agree: '我同意服务条款',
